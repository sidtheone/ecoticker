...
| Interface/contract change | Consumers break — tests catch the blast radius upfront |
...
| Swapping implementation (lib A to lib B, same API) | Tests shouldn't care about internals |
| Deleting code | Less code = less to test |
| Spike/prototype (throwaway) | You don't know the contract yet |
