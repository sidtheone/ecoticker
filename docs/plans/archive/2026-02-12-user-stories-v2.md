> **SUPERSEDED** — Stories converted to GSD epics in `_gsd-output/planning-artifacts/epic-*.md` (2026-02-17). This document retained as historical reference for persona journeys and design rationale.
